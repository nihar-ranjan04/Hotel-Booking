...
const HotelReg = () => {
    return (
        <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
            <form className='flex bg-white p-8 rounded-xl max-w-4xl max-md:mx-2'>
                <img src={assets.regImage} alt="reg-image" className='w-1/2 rounded-x1 hidden md:block' />
                <div className='relative flex flex-col itms-center md:w-1/2 p-8 md:p-10'>
                    ...
                    <div className='w-full mt-4 max-w-60 mr-auto'>
                        ...
                        <select className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light cursor-pointer' id='city' required>
