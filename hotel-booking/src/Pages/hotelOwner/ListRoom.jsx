...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Room Listings' subTitle='Explore our diverse range of rooms, each designed to provide comfort and style for your stay.' />
        ...
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr >
              ...
              <th className='py-3 px-4 font-medium text-center'>Facility</th>
